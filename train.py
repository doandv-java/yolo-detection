...
from models.yolo import create_yolo, compute_loss
from models.utils import load_yolo_weights
from models.configs import *
from mAP_eval import get_mAP
...
def main():
    ...
    if TRAIN_TRANSFER:
        ...
        load_yolo_weights(darknet, YOLO_WEIGHTS)  # use darknet weights
        ...
        for image_data, target in trainset:
            ...
            print(
                "epoch:{:2.0f} step:{:5.0f}/{}, lr:{:.6f}, giou_loss:{:7.2f}, conf_loss:{:7.2f}, prob_loss:{:7.2f}, total_loss:{:7.2f}".format(
                    epoch, cur_step, steps_per_epoch, results[1], results[2], results[3], results[4], results[5]))
